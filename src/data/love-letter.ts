import type { LoveLetter } from "@/types/love-letter";

/**
 * Placeholder letter (reference examples, marked replaceable — D-011).
 * Each entry in `content` is one paragraph.
 */
export const loveLetter: LoveLetter = {
  id: "carta-01",
  title: "Carta de amor",
  content: [
